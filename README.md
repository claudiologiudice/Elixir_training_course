...
<ul>
<li>In particular, during <a href="https://github.com/BioinfoUNIBA/epitran/blob/main/reditoolsdnarna.md"> this morning </a>, we will illustrate a computational workflow to discover novel RNA editing events using RNAseq data.
</li>
</ul>
</p>
